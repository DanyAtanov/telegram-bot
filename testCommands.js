const testCommands = (bot) => {
	...
	bot.command('testList', async (ctx) => {
		...
		ctx.session.lastTime = 0;
		ctx.session.userList = [
			{ id: 0, name: 'Владимир Путин', nickName: 'putin_test_2024', wins: 0, monthWins: 0 },
			{
				id: 1,
			...
			{ id: 2, name: 'Лоза', nickName: 'loza_loza_test_2024', wins: 0, monthWins: 0 },
			{ id: 3, name: 'Катюшка', nickName: 'katka_test_2024', wins: 0, monthWins: 0 },
			{ id: 4, name: 'Валентина', nickName: 'valya_test_2024', wins: 0, monthWins: 0 },
		];
